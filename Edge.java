public class Edge<T> implements Comparable<Edge<? super T>> {
     ...
     * @param reagent the reagent that characterizes the edge
     * @throws IllegalArgumentException if any of the arguments are null
     */
    public Edge(Vertex<T> u, Vertex<T> v, int weight, String reagent) {
        if (u == null || v == null) {
    ...
    /**
     * Gets the reagent associated with the edge.
     *
     * @return the reagent
     */
    ...
    public String toString() {
        return "Edge from " + u + " to " + v + " with weight " + weight + " and reagent(s) of " + reagent;
    }
}